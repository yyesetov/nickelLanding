...
const directions = {
  systems: {name:'Разработка информационной системы', title:'Информационные системы', description:'Разрабатываем сервисы под ваши процессы и объединяем их с существующими системами.', examples:['Корпоративные платформы','Личные кабинеты','Интеграции']},
  ai: {name:'AI-системы', title:'AI-системы', description:'Встраиваем AI в рабочие процессы и проверяем качество его работы на ваших данных.', examples:['AI-ассистенты','Поиск по внутренним знаниям','Обработка документов']},
  automation: {name:'Автоматизация бизнес-процессов', title:'Автоматизация процессов', description:'Убираем повторяющиеся ручные действия и связываем работу людей и систем.', examples:['Согласования и заявки','Обмен данными между системами','Контроль задач и сроков']},
  consulting: {name:'Консалтинг и архитектура', title:'Консалтинг и архитектура', description:'Находим ограничения в текущей системе и составляем план развития под цели бизнеса.', examples:['Аудит архитектуры','Выбор технологий','План изменений']}
};
